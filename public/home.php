...
<html lang="en">
    <head>
        ...
        <title>Home-Clinica Bondad</title>
        <!-- Favicon-->
    ...
    <body id="page-top">
        ...
        <nav id="sidebar-wrapper">
            <ul class="sidebar-nav">
                <li class="sidebar-brand"><a href="#page-top">Administrador</a></li>
                <li class="sidebar-nav-item"><a href="#page-top">Home</a></li>
                <li class="sidebar-nav-item"><a href="#citas">Citas</a></li>
        ...
        <header class="masthead d-flex align-items-center">
            <div class="container px-4 px-lg-5 text-center">
                <h1 class="mb-1" style="color:white;">Bienvenido</h1>
                <h3 class="mb-5"><em style="color:white;">Recuerda tener todo en orden</em></h3>
                <a class="btn btn-primary btn-xl" href="../config/cerrar_sesion.php" style="border-radius: 50px;">Cerrar Sesión</a>
            </div>
        </header>
        <!-- seccion de citas-->
                ...
                <div class="row gx-4 gx-lg-5 justify-content-center">
                    <div class="col-lg-12">
                        ...
                        <p class="lead mb-5" style="color: red;">
						    ...
						    Lista de Citas
						    <a href="../citas.html" target="_blanck" class="btn btn-primary btn-sm">Agendar citas</a>
					        </div>
                            ...
                            <tbody>
                                ...
                                { ?>
                                    ...
                                    <td><a href="../config/editarcitas.php?id=<?php echo $row["id"] ?>" class="btn btn-success btn-sm">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil" viewBox="0 0 16 16">
                                        <path d="M12.146.146a.5.5 0 0 1 .708 0l3 3a.5.5 0 0 1 0 .708l-10 10a.5.5 0 0 1-.168.11l-5 2a.5.5 0 0 1-.65-.65l2-5a.5.5 0 0 1 .11-.168l10-10zM11.207 2.5 13.5 4.793 14.793 3.5 12.5 1.207 11.207 2.5zm1.586 3L10.5 3.207 4 9.707V10h.5a.5.5 0 0 1 .5.5v.5h.5a.5.5 0 0 1 .5.5v.5h.293l6.5-6.5zm-9.761 5.175-.106.106-1.528 3.821 3.821-1.528.106-.106A.5.5 0 0 1 5 12.5V12h-.5a.5.5 0 0 1-.5-.5V11h-.5a.5.5 0 0 1-.468-.325z"/>
                                        </svg>
                                    </a></td>
                                    <td><a href="../config/eliminarcitas.php?id=<?php echo $row["id"] ?>" class="btn btn-danger btn-sm">
